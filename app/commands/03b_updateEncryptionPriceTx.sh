...
# Usage: ./03b_updateEncryptionPriceTx.sh <new_price_lovelace>
# Example: ./03b_updateEncryptionPriceTx.sh 10000000  (10 ADA)

if [ -z "${1:-}" ]; then
  echo -e "\033[0;31m Usage: $0 <new_price_lovelace> \033[0m"
  exit 1
fi
...
../data/encryption/encryption-update-price-redeemer.json | sponge ../data/encryption/encryption-update-price-redeemer.json
...
FEE=$(${cli} conway transaction build \
    ...
    --spending-reference-tx-in-redeemer-file ../data/encryption/encryption-update-price-redeemer.json \
