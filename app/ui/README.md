...
```
I am building an app defined in @ui/ui-goals.md. The fe and be will live in @ui/. I need you to move onto phase N and complete the task. After completion please add any notes you think might help the ai solve phase N+1 to @ui/ui-goals.md.
```
