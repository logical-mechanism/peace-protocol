  ...
  return (
    ...
    >
      <button
        ...
        className="inline-flex items-center justify-center w-4 h-4 rounded-full text-[var(--text-muted)] hover:text-[var(--accent)] focus-visible:text-[var(--accent)] focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-1 focus-visible:rounded-full transition-colors duration-[var(--transition-fast)] cursor-help"
      >
