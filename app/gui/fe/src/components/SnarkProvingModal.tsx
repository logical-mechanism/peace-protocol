 ...
 *
 * Shows an animated progress indicator while the native snark binary
 * generates the Groth16 proof (typically ~3 minutes).
 */
export default function SnarkProvingModal({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="snark-proving-title"
    >
      {/* Backdrop */}
      <div
      ...
      <div className={`relative w-full max-w-md max-h-[90vh] bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-[var(--radius-xl)] shadow-lg flex flex-col ${animationState === 'exiting' ? 'modal-panel-exit' : 'modal-panel-enter'}`}>
        {/* Header */}
        ...
        <div className="px-6 py-8 space-y-6">
          {(state === 'initializing' || state === 'proving') && (
            <div aria-live="polite">
              ...
              {/* Warning */}
              <div className="bg-[var(--warning-muted)] text-[var(--warning)] rounded-[var(--radius-md)] px-4 py-3 text-sm flex items-center gap-2 mt-6">
