...
beforeEach(() => {
  ...
  mockGetOnboardingState.mockReturnValue({ step: 0, completed: false });
  mockAdvanceOnboardingStep.mockReturnValue({ step: 1, completed: false });
});
...
describe('OnboardingOverlay', () => {
  ...
  it('does not render when completed', () => {
    mockGetOnboardingState.mockReturnValue({ step: 0, completed: true });
    const { container } = render(<OnboardingOverlay />);
  ...
  it('renders step 2 content on /node-sync route', () => {
    mockGetOnboardingState.mockReturnValue({ step: 1, completed: false });
  ...
  it('shows "Done" button on last step', () => {
    mockGetOnboardingState.mockReturnValue({ step: 3, completed: false });
    mockPathname = '/dashboard';
    mockAdvanceOnboardingStep.mockReturnValue({ step: 3, completed: true });
    render(<OnboardingOverlay />);
