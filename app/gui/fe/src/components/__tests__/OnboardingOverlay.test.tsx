...
beforeEach(() => {
  ...
  mockGetOnboardingState.mockReturnValue({ step: 0, completed: false, firstListingCompleted: false, firstBidCompleted: false, firstDecryptCompleted: false, firstBidAcceptedCompleted: false });
  mockAdvanceOnboardingStep.mockReturnValue({ step: 1, completed: false, firstListingCompleted: false, firstBidCompleted: false, firstDecryptCompleted: false, firstBidAcceptedCompleted: false });
});
...
describe('OnboardingOverlay', () => {
  ...
  it('does not render when completed', () => {
    mockGetOnboardingState.mockReturnValue({ step: 0, completed: true, firstListingCompleted: false, firstBidCompleted: false, firstDecryptCompleted: false, firstBidAcceptedCompleted: false });
    const { container } = render(<OnboardingOverlay />);
  ...
  it('renders step 2 content on /node-sync route', () => {
    mockGetOnboardingState.mockReturnValue({ step: 1, completed: false, firstListingCompleted: false, firstBidCompleted: false, firstDecryptCompleted: false, firstBidAcceptedCompleted: false });
  ...
  it('shows "Done" button on last step', () => {
    mockGetOnboardingState.mockReturnValue({ step: 3, completed: false, firstListingCompleted: false, firstBidCompleted: false, firstDecryptCompleted: false, firstBidAcceptedCompleted: false });
    mockPathname = '/dashboard';
    mockAdvanceOnboardingStep.mockReturnValue({ step: 3, completed: true, firstListingCompleted: false, firstBidCompleted: false, firstDecryptCompleted: false, firstBidAcceptedCompleted: false });
    render(<OnboardingOverlay />);
