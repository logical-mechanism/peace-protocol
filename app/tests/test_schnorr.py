...
def test_fsh():
    ...
    assert fiat_shamir_heuristic(g, gr, u) == "ace9c7140e074ae54571dc5707ba6d16287d7ae883bd6062957f04bb"
    assert to_int(fiat_shamir_heuristic(g, gr, u)) == 18209884714012616100516315861408918984119144601440871754214320047291
